...
static char *syserrstr()
{
    return (strerror(errno));
}
static FILE *fopenh (char *name, char *how)
{
...
static char *rcsid[2] = {(char *)rcsid, "@(#) $RCSfile: gsc.c,v $ $Date: 2001/04/19 21:12:14 $ $Revision: 1.1.1.1 $ $Name:  $"};
